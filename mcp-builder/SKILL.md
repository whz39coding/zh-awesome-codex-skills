---
name: mcp-builder
description: 指导创建高质量 MCP（Model Context Protocol）servers，让 LLM 通过设计良好的 tools 与外部服务交互。适用于用 Python/FastMCP 或 Node/TypeScript MCP SDK 集成外部 API 或服务。Keywords: MCP server, FastMCP, MCP SDK.
